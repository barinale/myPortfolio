...
export const MyProject = () => {
    ...
    {id:5,UrlCode:'https://github.com/barinale/busnis',UrlView:'https://barinale.github.io/busnis/',ImageUrl:'./assestsO/busnin.png',TechnologyUser:[]},
    {id:6,UrlCode:'https://github.com/barinale/earwear',UrlView:'https://barinale.github.io/earwear/',ImageUrl:'./assestsO/OpenDAta.png',TechnologyUser:[1,2,3,4]},
    {id:7,UrlCode:'https://github.com/barinale/mouta',UrlView:'https://barinale.github.io/mouta/',ImageUrl:'./assestsO/OpenDAta.png',TechnologyUser:[1,2,3]}
]
  return (
